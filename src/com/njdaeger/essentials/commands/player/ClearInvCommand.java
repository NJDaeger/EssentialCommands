...
public class ClearInvCommand extends BukkitCommand {
	...
	public ClearInvCommand() {
		...
		this.setPermission(Permission.ESS_CLEAR.getPermission());
		this.setPermission(Permission.ESS_CLEAR_OTHER.getPermission());
	...
	public boolean execute(CommandSender sndr, String label, String[] args) {
		if (sndr instanceof Player) {
			...
			if (TargetHasPermission.check(player, Permission.ESS_CLEAR, Permission.ESS_CLEAR_OTHER)) {
				if (args.length == 0) {
				...
				if (args.length == 1) {
					if (TargetHasPermission.check(player, Permission.ESS_CLEAR_OTHER)) {
