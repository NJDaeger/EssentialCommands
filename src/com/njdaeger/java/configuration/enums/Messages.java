...
public enum Messages {
	...
	ERROR_NICKNAME_TOO_LONG("%%%%%PARSER_HERE%%%%%", "&cError: &4The nickname given is too long.", "error-nickname-too-long"), //Custom {MAXLENGTH} {GIVEN}
	...
	ERROR_TARGET_NOT_SIGN("%%%%%PARSER_HERE%%%%%", "&cError: &4Target block is not a sign.", "error-target-not-sign"), //Custom {TARGET}
	...
	ERROR_DATABSE_NOT_FOUND("%%%%%PARSER_HERE%%%%%", "&cError: &4Database could not be found.", "error-database-not-found"), //Custom {DATABSE} {DATABASES}
	...
	ERROR_INVALID_COMMAND_SENDER("%%%%%PARSER_HERE%%%%%", "&cError: &4Invalid command sender.", "error-invalid-command-sender"), //Custom {SENDER}
