...
public class CommandEvent {
	...
	public void whenAfk(PlayerCommandPreprocessEvent e) {
		...
		if (PlayerConfig.getConfig(e.getPlayer()).isAfk() == true) {
			if (
					afkCommand.getAliases().contains(message) ||
					afkCommand.getName().equalsIgnoreCase(message) ||
					messageCommand.getAliases().contains(message) ||
					messageCommand.getName().equalsIgnoreCase(message) ||
					replyCommand.getAliases().contains(message) ||
					...
					vanishCommand.getAliases().contains(message) ||
